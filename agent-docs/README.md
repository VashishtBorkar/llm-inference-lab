...
This directory contains detailed development context for maintainers and AI agents.
The root README is intentionally concise and public-facing; keep implementation
notes, experiment ideas, and long-term planning here.

Recommended reading order:

1. [Systems roadmap](roadmap.md)
2. [Benchmark methodology](benchmark-methodology.md)
