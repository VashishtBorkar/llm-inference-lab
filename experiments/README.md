...
| `exp-005-natural-corpus-prefill-scaling` | How does Ollama prefill behavior change from 128 to 16,384 natural-language prompt tokens on an RTX A6000? | Preflight passed at all 8 prompt lengths; ready for 3 full trials | [Protocol](exp-005-natural-corpus-prefill-scaling/report.md) |
