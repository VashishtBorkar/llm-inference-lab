...
| `exp-005-natural-corpus-prefill-scaling` | How does Ollama prefill behavior change from 128 to 16,384 natural-language prompt tokens on an RTX A6000? | Complete: throughput peaked at 2,048 tokens, then fell 18% by 16,384 tokens as prefill became superlinear | [Report](exp-005-natural-corpus-prefill-scaling/report.md) |
| `exp-006-ollama-prefill-kernel-scaling` | Why does Ollama prefill efficiency decline at long context lengths? | Complete: MLP matmul scaled linearly from 2K to 16K while Flash Attention grew 45.9x | [Report](exp-006-ollama-prefill-kernel-scaling/report.md) |
